...
const Footer = () => {
  return (
    <footer className='w-full'>
      ...
      {/* Big brand name */}
      <div className='border-b border-[#2C2C2A] px-1 md:px-14 lg:px-39 pt-6 md:py-8 '>
        <h2 className='font-heading font-bold uppercase tracking-[0.18em] text-[clamp(32px,8vw,100px)] text-[#2C2C2A] leading-none'>
          ASH ARTS GALLERY
        </h2>
      </div>

      {/* Bottom row */}
      <div className='px-6 md:px-14 lg:px-20 pt-4 flex flex-col md:flex-row items-center justify-between gap-1 md:gap-4'>
        ...
        <div className='flex items-center gap-5'>
          ...
          <a href='https://www.behance.net/ashendewinda'
            ...
            className='text-gray-400 hover:text-[#1769FF] transition-colors duration-200'>
            <FaBehance size={20} />
          </a>
        </div>

        {/* Copyright */}
        <p className='font-body text-sm text-[#888780] text-center'>
          © {new Date().getFullYear()} Ash Arts Gallery. All rights reserved.
        </p>

        {/* Designed by */}
        <p className='font-body text-sm text-[#888780]'>
          Designed by{' '}
          <a href='https://www.dinuja.online/' target='_blank' rel='noopener noreferrer'
            className='text-[#2C2C2A] hover:text-blue-500 transition-colors duration-200 hover:underline'>
            Dinuja Ubeysinghe
          </a>
        </p>
